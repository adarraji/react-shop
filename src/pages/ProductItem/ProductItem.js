                ...
                <div className="flex-1 pv0 ph5 tl">
                    ...
                    <div className="w-50 mv4 mh0 flex justify-between">
                        <div className="flex items-center">
                            ...
                            <div className="circle-20 bg-black mv0 mh1 pointer"></div>
                            <div className="circle-20 bg-dark-blue mv0 mh1 pointer"></div>
                            <div className="circle-20 bg-gray mv0 mh1 pointer"></div>
                        </div>
                        <div className="flex items-center">
